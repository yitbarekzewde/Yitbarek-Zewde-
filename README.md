<title>Ethiopian Beauty | የኢትዮጵያ ውበት</title> <style> @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600;700&display=swap');
    * {
        margin: 0;
        padding: 0;
    ...
    @media (max-width: 768px) {
        ...
        .sticky-header {
           ...
           background: linear-gradient(to bottom,#00843D,#FCD116,#DA121A);
           ...
           background: repeating-liner-gradient (to bottom,#00843D, 0%,#00843D 33.33%,#FCD1FCD16 66.66%,#DA121A 100%);
    }
...
<div class="container">
    ...
    <header class="header">
        ...
        <h1>ኢትዮጵያ ታበጽሕ እደዊሃ ኀበ እግዚአብሔር  መዝ ፷፯÷፴፩ </h1>
        <h1>ኢትዮጵያ እጆቿን ወደ እግዚአብሔር ትዘረጋለች መዝ 67÷31</h1>
    ...
    <footer class="footer">
        ...
        <p style="margin-top: 30px;">© 2026 (2018 EC) Ethiopian Beauty | የኢትዮጵያ ውበት</p>
        <p style="font-size: 0.9rem; opacity: 0.8;">Developed by Yitbarek Zewde 💚💛❤️</p>
    </footer>
</div>
